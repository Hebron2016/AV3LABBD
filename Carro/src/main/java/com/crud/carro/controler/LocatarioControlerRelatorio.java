...
@Controller
public class LocatarioControlerRelatorio {

	@Autowired
	private DataSource ds;
	
	@SuppressWarnings({"rawtypes","unchecked"})
	@RequestMapping(name="locatariorelatorio", value = "/locatariorelatorio", method = RequestMethod.POST)
