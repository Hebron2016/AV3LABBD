...
@Controller
public class AluguelControlerRelatorio {

	@Autowired
	private DataSource ds;
	
	@SuppressWarnings({"rawtypes","unchecked"})
	@RequestMapping(name="aluguelrelatorio", value = "/aluguelrelatorio", method = RequestMethod.POST)
	public ResponseEntity geraRelatorio(@RequestParam Map<String, String> params) {
		...
		relatorioParams.put("diaEntrada", diaEntrada);
